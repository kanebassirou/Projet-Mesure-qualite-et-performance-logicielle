...
def ajouter_membres(projet):
    ...
    while True:
        ...
        continuer = input("Voulez-vous ajouter un autre membre? (oui/non): ").strip().lower()
        if continuer != "oui":
            break
    return membres
...
def ajouter_taches(projet, membres):
    while True:
        ...
        continuer = input("Voulez-vous ajouter une autre tâche? (oui/non): ").strip().lower()
        if continuer != "oui":
            break
...
def ajouter_risques(projet):
    while True:
        ...
        continuer = input("Voulez-vous ajouter un autre risque? (oui/non): ").strip().lower()
        if continuer != "oui":
            break
...
def ajouter_jalons(projet):
    while True:
        ...
        continuer = input("Voulez-vous ajouter un autre jalon? (oui/non): ").strip().lower()
        if continuer != "oui":
            break
...
def main():
    ...
    date_debut_projet = datetime.strptime(input("Entrez la date de début du projet (AAAA-MM-JJ): "), '%Y-%m-%d')
    date_fin_projet = datetime.strptime(input("Entrez la date de fin du projet (AAAA-MM-JJ): "), '%Y-%m-%d')
    ...
    choix_strategie = input("Choisissez la stratégie de notification (email, sms, push): ").strip().lower()
    if choix_strategie == "email":
        ...
        print("Stratégie de notification non reconnue, utilisation de la stratégie email par défaut.")
        projet.definir_strategie_notification(StrategieNotificationEmail())
